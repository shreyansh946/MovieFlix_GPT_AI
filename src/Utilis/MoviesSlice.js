...
export const { addNowplayingMovies, addTrailerVideo, addPopularMovies, addTopRatedMovies, addUpComingMovies, addFavouriteMovie, removeFavouriteMovie, addWatchList, removeWatchList, addSimilarMovies, addRecommendedMovies } = MoviesSlice.actions;
