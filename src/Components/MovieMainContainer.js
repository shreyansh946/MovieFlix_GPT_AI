...
import { addFavouriteMovie, addWatchList, removeFavouriteMovie, removeWatchList } from '../Utilis/MoviesSlice';
  ...
  return (
    ...
    <div>
      ...
      <img
        ...
        alt="backdropImg"
        src={IMG_CDN + details.movieDetails?.backdrop_path}
      />
      ...
      <div >            
        ...
        <div className="mt-[100px] w-28 relative top-16 md:top-0 md:bottom-6 left-10 md:left-0 md:w-4/12 md:p-20 flex md:pt-[130px]">
          <img
            ...
            alt="moviePoster"
            src={IMG_CDN + details.movieDetails?.poster_path}
          />
        </div>
      ...
      <div className="w-full h-screen fixed top-0 left-0 right-0 md:right-40 flex items-center justify-center bg-black bg-opacity-75 z-50">
          ...
          <div className="aspect-video px-2">
            <VBG movieId={movieId} widthScreen="w-8/12" />
          </div>
        </div>
      </div>
    )}
